package xismobile.pim.uml2.gen.windowsphone.services;
...
import xismobile.pim.uml2.gen.windowsphone.main.Uml2WindowsPhone;
import xismobile.pim.uml2.gen.windowsphone.services.ServiceUtils.MenuType;
...
public class Services {
	...
	public void addLibrary(String jar) {
		try {
			...
			String target = Uml2WindowsPhone.targetFolderPath + "/libs/";
			JarFile srcFile = new JarFile(Uml2WindowsPhone.jarPath + "/WindowsPhoneGenerator.jar");
	 ...
	 * @param projectFolder the relative path of the project folder
	 * @param fileFolder the relative path of the file folder
	 */
	public void addDrawable(String fileName, String projectFolder, String fileFolder) {
		try {
			boolean fileExists = false;
			String target = Uml2WindowsPhone.targetFolderPath + "/" + projectFolder + "/";
			...
			Enumeration<JarEntry> entries = srcFile.entries();
			JarEntry entry = null;
			String icons = fileFolder != null ? "icons/" + fileFolder + "/" : "icons/";
...
//		Uml2WindowsPhone.stringResources.put(key, value);
//	}
//	
	/**
...
//		
//		for (String key : Uml2WindowsPhone.stringResources.keySet()) {
//			sb.append(String.format(resource, key, Uml2WindowsPhone.stringResources.get(key)));
//		}
//		
//		if (sb.length() > 0) {
